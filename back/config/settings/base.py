...
# BREVO :
BREVO_ACTIVE = os.getenv("BREVO_ACTIVE") == "true"
BREVO_API_KEY = os.getenv("BREVO_API_KEY")
BREVO_ONBOARDING_LIST = os.getenv("BREVO_ONBOARDING_LIST")
BREVO_ONBOARDING_PUTATIVE_MEMBER_LIST = os.getenv(
    "BREVO_ONBOARDING_PUTATIVE_MEMBER_LIST"
)
BREVO_ONBOARDING_MEMBER_LIST = os.getenv("BREVO_ONBOARDING_MEMBER_LIST")
