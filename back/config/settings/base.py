...
ANON_THROTTLE_RATE_PER_MINUTE = os.getenv("ANON_THROTTLE_RATE_PER_MINUTE", "240000")
USER_THROTTLE_RATE_PER_MINUTE = os.getenv("USER_THROTTLE_RATE_PER_MINUTE", "1200000")
USER_UPLOAD_THROTTLE_RATE_PER_MINUTE = os.getenv(
    "USER_UPLOAD_THROTTLE_RATE_PER_MINUTE", "50000"
)
STRUCTURE_UPLOAD_THROTTLE_RATE_PER_HOUR = os.getenv(
    "STRUCTURE_UPLOAD_THROTTLE_RATE_PER_HOUR", "200000"
)
