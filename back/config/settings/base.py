...
UPLOAD_THROTTLE_RATE_PER_MINUTE = os.getenv("UPLOAD_THROTTLE_RATE_PER_MINUTE", "5")
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        ...
        "upload": f"{UPLOAD_THROTTLE_RATE_PER_MINUTE}/minute",
...
ORIENTATION_EXPIRATION_EMAILS_ENABLED = (
    os.getenv("ORIENTATION_EXPIRATION_EMAILS_ENABLED") == "true"
)
