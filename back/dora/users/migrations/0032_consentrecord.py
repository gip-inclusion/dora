# Generated by Django 5.2.6 on 2025-10-22 14:02
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["anonymous_id", "-created_at"],
                        name="users_conse_anonymo_d7875c_idx",
                    ),
                ],
                "constraints": [
                    models.CheckConstraint(
                        condition=models.Q(
                            models.Q(
                                ("anonymous_id__isnull", True), ("user__isnull", False)
                            ),
                            models.Q(
                                ("anonymous_id__isnull", False), ("user__isnull", True)
                            ),
                            _connector="OR",
                        ),
