...
def test_structures_serialization_exemple(
    ...
    assert data == {
        ...
        "longitude": 7.848133,
        "nom": "MOBILETTE",
        "presentation_detail": "L’association Mobilette propose des solutions de déplacement aux personnes pour qui la non mobilité est un frein à l’insertion professionnelle : - connaissance de l'offre de transport du territoire - accès à un véhicule 2 ou 4 roues - transport solidaire - accès au permis",
