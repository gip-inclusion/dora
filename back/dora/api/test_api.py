...
def test_service_serialization_exemple(authenticated_user, api_client, settings):
    ...
    service = make_service(
        ...
        name="TISF",
        description="Service de proximité visant à soutenir les familles ayant la responsabilité de jeunes enfants, en particulier les familles monoparentales.",
    ...
    expected = {
        ...
        "presentation_resume": "Service de proximité visant à soutenir les familles ayant la responsabilité de jeunes enfants, en particulier les familles monoparentales.",
