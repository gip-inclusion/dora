...
def make_di_service_data(**kwargs) -> dict:
    ...
    return {
        **{
            ...
            "lien_source": "https://dora.inclusion.gouv.fr/services/ass-pour-droit-a-l-i-nhes",
            "date_maj": "2025-02-14",
            "type": "accompagnement",
            ...
            "structure": {
                ...
                "lien_source": "https://dora.inclusion.gouv.fr/structures/ass-pour-droit-a-l-i-nhes",
