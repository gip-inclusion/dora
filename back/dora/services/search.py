...
def search_keyword(request, api_params):
    ...
    results, metadata = _process_di_results(
        ...
        max_distance=None,
        # d·i gère la pagination. DORA ne devrait pas retirer de résultats,
        # cela rendrait incorrect la pagination et le total de résultats d·i.
