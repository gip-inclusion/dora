...
def _orientation_prescriber_context(orientation) -> dict:
    """Données du prescripteur pour les templates, agnostiques à la source (Dora ou Les Emplois)."""
    return {
        "prescriber_full_name": orientation.prescriber_info.full_name,
        "prescriber_structure_name": orientation.prescriber_info.structure_name,
        "prescriber_structure_url": orientation.prescriber_info.structure_url,
    }
...
def _orientation_created_ctx(orientation) -> dict:
    return {
        ...
        **_orientation_prescriber_context(orientation),
    }
