...
<div class="text-f14 text-france-blue">
  <div
    class={`mr-s4 px-s16 py-s8 inline-flex items-center self-start rounded-md ${expanded ? "bg-france-blue rounded-br-none rounded-bl-none text-white" : "bg-service-blue-light"}`}
  >
  ...
  <div class:hidden={!expanded} class="w-full md:w-auto print:block!">
    <ul
      class="gap-s12 bg-service-blue-light p-s16 pr-s32 relative z-10 mt-[-1px] inline-flex w-full flex-col rounded-md rounded-tl-none md:w-auto"
    >
