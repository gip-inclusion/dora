...
const config = {
  ...
  theme: {
    colors: {
      ...
      info: { DEFAULT: "hsl(212,93%,46%)", light: "hsl(212,93%,98%)" },
      success: { DEFAULT: "hsl(148,100%,27%)", light: "hsl(148,100%,98%)" },
      warning: { DEFAULT: "hsl(32,100%,46%)", light: "hsl(32,100%,98%)" },
      error: { DEFAULT: "hsl(2,100%,44%)", light: "hsl(2,100%,98%)" },
